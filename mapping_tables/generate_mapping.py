...
def print_table_in_latex():
    ...
    save_file.write('\\documentclass[aps,reprint,onecolumn]{revtex4-1}\n'+\
                    ...
                    '\\usepackage{dcolumn}\n'+\
                    '\\begin{document}\n'+\
                    '\\section{Mapping table of symmetry-based indicators and topological invariants in magnetic space groups}\n'+\
